...
/* Add ConTroll page templates */

class ConTrollPageTemplater {
	/**
	...
	*/
	public static function get_instance() {
		...
		return self::$instance = new ConTrollPageTemplater();
	}
	...
	private function __construct() {
		...
		$this->templates = [
			'pages/page-controlluserflow.php' => 'ConTroll User Login/Passwords',
			'pages/page-mypage.php' => 'ConTroll User Page/Cart',
	...
	public function view_project_template($template) {
		...
		if (!isset($this->templates[$pm]))
			return $template;

		$file = plugin_dir_path(__FILE__) . $pm;
